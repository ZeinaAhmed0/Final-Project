...
function LayoutProvider({ children }) {
    ...
    return (
        <>
            ...
            <div className="flex">
                <div className={`bg-sky-700 py-2 z-50 transition-transform duration-300 fixed top-0 left-0 lg:relative lg:translate-x-0 ${isAsideOpen ? 'translate-x-0' : '-translate-x-full'} md:fixed  sm:fixed`}>
