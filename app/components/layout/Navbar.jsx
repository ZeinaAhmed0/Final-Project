...
function Navbar({ toggleAside }) {
  ...
  return (
    <>
      {isLogin && (
        <nav className='navbar bg-sky-600 shadow-sm w-full p-2 z-40 capitalize flex items-center justify-between transition-all duration-300 '>
          <div className="w-full px-6 py-1 mx-auto flex items-center justify-between">
            <div className='flex items-center gap-5 justify-center'>
              <div className="Aside-menu cursor-pointer text-2xl sm:block md:block lg:hidden" onClick={toggleAside}>
                <SlMenu />
              </div>
              <div className="logo">
