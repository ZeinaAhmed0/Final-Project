...
function AddNewEmpForm() {
    ...
    const validationSchema = Yup.object({
        ...
        annualLeaves: Yup.number().required('Annual Leaves is required'),
        emergencyLeave: Yup.number().required('Emergency Leave is required'),
        restDay: Yup.number().required('Rest Days is required'),
                        ...
                        <Form className="space-y-4 p-6 bg-white rounded shadow-md">
                            <div className='flex flex-col md:flex-row gap-4'>
                                <div className='flex-1'>
                                    <label htmlFor="fullName" className="block font-semibold text-[var(--color-primary)] mb-1">Full Name :</label>
                                ...
                                <div className='flex-1'>
                                    <label htmlFor="employeePassword" className="block font-semibold text-[var(--color-primary)] mb-1">Password :</label>
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className='flex-1'>
                                    <label htmlFor="employeeEmail" className="block font-semibold text-[var(--color-primary)] mb-1">Email :</label>
                                ...
                                <div className="flex-1">
                                    <label htmlFor="jobTitle" className="block font-semibold text-[var(--color-primary)] mb-1">Job Title :</label>
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="flex-1">
                                    <label htmlFor="birthday" className="block font-semibold text-[var(--color-primary)] mb-1">Birthday :</label>
                                ...
                                <div className="flex-1">
                                    <label htmlFor="phoneNumber" className="block font-semibold text-[var(--color-primary)] mb-1">Phone Number :</label>
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="flex-1">
                                    <label htmlFor="salary" className="block font-semibold text-[var(--color-primary)] mb-1">Salary :</label>
                                ...
                                <div className="flex-1">
                                    <label htmlFor="location" className="block font-semibold text-[var(--color-primary)] mb-1">Location :</label>
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="flex-1">
                                    <label htmlFor="directManager" className="block font-semibold text-[var(--color-primary)] mb-1">Direct Manager :</label>
                                ...
                                <div className="flex-1">
                                    <label htmlFor="manager" className="block font-semibold text-[var(--color-primary)] mb-1">Manager :</label>
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="flex-1">
                                    <label htmlFor="department" className="block font-semibold text-[var(--color-primary)] mb-1">Department :</label>
                                ...
                                <div className="flex-1">
                                    <label htmlFor="subDepartment" className="block font-semibold text-[var(--color-primary)] mb-1">Sub Department :</label>
                            ...
                            <div className='flex flex-col md:flex-row gap-4'>
                                <div className='flex-1'>
                                    <label htmlFor="annualLeaves" className="block font-semibold text-[var(--color-primary)] mb-1">annual leaves :</label>
                                ...
                                <div className='flex-1'>
                                    <label htmlFor="emergencyLeave" className="block font-semibold text-[var(--color-primary)] mb-1">emergency leave :</label>
                                ...
                                <div className='flex-1'>
                                    <label htmlFor="restDay" className="block font-semibold text-[var(--color-primary)] mb-1">rest days :</label>
                            ...
                            <div className="flex flex-col gap-2">
                                <label htmlFor="employeeImg" className="block font-semibold text-[var(--color-primary)] mb-1">Employee Image :</label>
                                <input
                                    id="employeeImg"
                                    name="employeeImg"
                                    type="file"
                            ...
                            <div className="flex justify-end">
                                <button type="submit" disabled={isSubmitting} className="btn bg-[var(--color-primary)]">
