...
function VacationApproval() {
    ...
    const handleApprove = async () => {
        const selectedIds = Object.keys(selected).filter(documentId => selected[documentId]);
        ...
        try {
            for (const documentId of selectedIds) {
                await updateVacationStatus(documentId, true);
            }
    ...
    const handleRejectSelected = async () => {
        ...
        try {
            for (const documentId of selectedIds) {
                await updateVacationStatus(documentId, false);
            }
